    ...
    <div>
        <div class="mx-auto max-w-7xl sm:px-6 h-full lg:px-4 dark:bg-white">
            <div class="overflow-hidden bg-white rounded-lg shadow-xl dark:bg-white sm:rounded-lg ">
                ...
                <div class="bg-gray-100 rounded-lg dark:bg-gray-100 ">
                    <table class="min-w-full border rounded-lg dark:border-gray-200">
                        <thead>
                            <tr class="bg-gray-100 rounded-lg dark:bg-gray-100">
                                ...
                                <th class="border px-1 py-1 dark:border-black">Nama Barang</th>
                                <th class="border px-1 py-1 dark:border-black">Jumlah Stok</th>
                                <th class="border dark:border-black">Tindakan</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach ($stocks as $index => $stock)
                                <tr class="bg-white dark:bg-gray-100">
                                    ...
                                    <td class="border px-6 py-3 dark:border-black">{{ $stock->item->name }}</td>
                                    <td class="border px-6 py-3 dark:border-black">{{ $stock->quantity }}</td>
                                    <td class="px-2 py-3 border dark:border-black justify-center">
                                        ...
                                        <form action="/stocks-{{ $stock->id }}" method="POST" class="inline-block">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit"
