                    ...
                    <table class="min-w-full border rounded-lg dark:border-gray-200">
                        ...
                        <tbody>
                            ...
                            <tr class="bg-white dark:bg-gray-100">
                                ...
                                <td class="px-6 py-3 border dark:border-black">{{ $item->demand_rate }} {{
                                    $item->unit }} </td>
                                ...
                                <td class="px-6 py-3 border dark:border-black">
                                    <a href="/items-edit-{{ $item->id }}"
                                        class="flex px-2 py-2 mx-1 mb-1 font-bold text-white bg-blue-500 rounded hover:bg-blue-700">
                                    ...
                                    <form action="/items/{{ $item->id }}" method="POST" class="inline-block">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" wire:click="showDialogAlert"
