                    ...
                    <table class="min-w-full border rounded-lg dark:border-gray-200">
                        <thead>
                            <tr class="bg-gray-100 rounded-lg dark:bg-gray-100 ">
                                ...
                                <th class="border px-6 py-3 dark:border-black">Tanggal Penjualan</th>
                        ...
                        <tbody>
                            ...
                            <tr class="bg-white dark:bg-gray-100">
                                <td class="border px-6 py-3 dark:border-black">{{ $sale->id }}</td>
                                <td class="border px-6 py-3 dark:border-black">{{ $sale->item->name }}</td>
                                <td class="border px-6 py-3 dark:border-black">{{ $sale->quantity_sold }}</td>
                                <td class="border px-6 py-3 dark:border-black">{{ $sale->selling_price }}</td>
                                <td class="border px-6 py-3 dark:border-black">{{ $sale->sale_date }}</td>
